...
export const integrations = pgTable(
  ...
  (table) => [
    uniqueIndex('integrations_user_id_provider_idx').on(table.userId, table.provider),
  ],
)
...
export const userSettings = pgTable('user_settings', {
  ...
  autoplayMediaPreviews: boolean('autoplay_media_previews').notNull().default(false),
  compactNotifications: boolean('compact_notifications').notNull().default(false),
