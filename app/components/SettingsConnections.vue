...
<template>
  <section class="set-section">
    ...
    <div class="conn-grid">
      <div v-for="connection in items" :key="connection.id" class="conn">
        ...
        <div class="conn-info">
          ...
          >
            {{
              [connection.account, connection.since].filter(Boolean).join(" · ")
            }}
          </div>
        </div>
        <button
    ...
    <div v-if="showBlueskyForm" class="bluesky-form">
      <p class="desc">
      ...
      <div class="form-row">
        <label for="bluesky-app-password">App Password</label>
        <input
